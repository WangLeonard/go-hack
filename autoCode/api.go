...
func AutoInjectionCode(filepath string, funcName string, startComment string, endComment string, codeData string) error {
	...
	// Record the spaces and tabs in front of the "//", to keep the format consistent.
